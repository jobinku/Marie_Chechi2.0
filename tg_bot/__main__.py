...
എന്റെ ന്യൂ ഫീച്ചേർസ് ചാനലിൽ @Bot_Update_bot ഇടുന്നതായിരിക്കും.....

എന്നെ നോക്കി നടത്തുന്നത്  [ഇദ്ദേഹം](@MuSkysM) ആണ് . എന്നെ നിർമിച്ചിരിക്കുന്നത് python3യിൽ 
python-telegram-bot library ഉപയോഗിച്ചാണ്.... ഞാൻ പൂർണമായും opensource ആണ്.. എൻറെ ചാനൽ നിങ്ങൾക്ക് [ഇവിടെ](https://Bot_Update_bot) കാണാവുന്നതാണ്...
...
def start(bot: Bot, update: Update, args: List[str]):
    if update.effective_chat.type == "private":
        ...
        update.effective_message.reply_text("ഹായ് മച്ചാൻ, എന്താ?")
